	...
	if nbRows == 0 {
		q := `
			...
			VALUES 
				...
				(?, 'Epargne', 		'all', 		3, 1, 'line-chart', 'e904', 'light blue', '(210,60,50)', '#3380CC'),
				(?, 'Habitude-', 	'all', 		4, 0, 'thumbs-down', 'e91e', 'red', '(1,60,50)', '#CC3633'),
				(?, 'Vehicule', 	'all', 		5, 0, 'car-front', 'e900', 'orange', '(15,60,50)', '#CC5933'),
				(?, 'Transport', 	'all', 		6, 0, 'train-front', 'e913', 'orange', '(30,60,50)', '#CC8033'),
				(?, 'Shopping', 	'basic', 	7, 0, 'shopping-cart', 'e918', 'yellow', '(45,40,50)', '#B3994D'),
				(?, 'Cadeaux', 		'basic', 	8, 0, 'gift', 'e91a', 'yellow', '(60,40,50)', '#B3B34D'),
				(?, 'Courses', 		'all', 		9, 0, 'carrot', 'e916', 'yellow', '(70,50,50)', '#AABF40'),
				(?, 'Resto', 		'basic', 	10, 0, 'chef-hat', 'e914', 'green', '(90,60,50)', '#80CC33'),
				(?, 'Loisirs', 		'all', 		11, 0, 'drama', 'e901', 'green', '(110,60,50)', '#4DCC33'),
				(?, 'Voyage', 		'basic', 	12, 0, 'earth', 'e902', 'green', '(130,60,50)', '#33CC4C'),
				(?, 'Revenu', 		'periodic', 13, 0, 'credit-card', 'e903', 'teal', '(160,60,50)', '#33CC99'),
