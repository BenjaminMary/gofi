	...
	s.Router.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/param", func(r chi.Router) {
				...
				r.Post("/force-new-login-on-ip-change", func(w http.ResponseWriter, r *http.Request) { api.PostParamForceNewLoginOnIPchange(w, r, false) })
	...
	s.Router.Route("/", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/param", func(r chi.Router) {
				...
				r.Post("/force-new-login-on-ip-change", front.PostParamForceNewLoginOnIPchange)
