...
func TestRecord(t *testing.T) {
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":1,\"GofiID\":2,\"Date\":\"2011-11-11\",\"Account\":\"CB\",\"Product\":\"testb\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-1.00\",\"PriceIntx100\":-100,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":2,\"GofiID\":1,\"Date\":\"2011-11-11\",\"Account\":\"CB\",\"Product\":\"test\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-1.00\",\"PriceIntx100\":-100,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":3,\"GofiID\":2,\"Date\":\"2010-12-31\",\"Account\":\"CB\",\"Product\":\"testb\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-1.00\",\"PriceIntx100\":-100,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":5,\"GofiID\":2,\"Date\":\"2012-05-11\",\"Account\":\"CB\",\"Product\":\"Transfert+\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"143.70\",\"PriceIntx100\":14370,\"Category\":\"Banque\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false},{\"ID\":4,\"GofiID\":2,\"Date\":\"2012-05-11\",\"Account\":\"A\",\"Product\":\"Transfert-\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-143.70\",\"PriceIntx100\":-14370,\"Category\":\"Banque\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":10,\"GofiID\":2,\"Date\":\"2012-02-14\",\"Account\":\"CB\",\"Product\":\"ToDelete\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.53\",\"PriceIntx100\":-3453,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false},{\"ID\":9,\"GofiID\":2,\"Date\":\"2012-02-07\",\"Account\":\"CB\",\"Product\":\"ToDelete\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.53\",\"PriceIntx100\":-3453,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false},{\"ID\":8,\"GofiID\":2,\"Date\":\"2012-01-31\",\"Account\":\"CB\",\"Product\":\"ToDelete\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.53\",\"PriceIntx100\":-3453,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false},{\"ID\":7,\"GofiID\":2,\"Date\":\"2012-01-31\",\"Account\":\"A\",\"Product\":\"Loyer\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-641.09\",\"PriceIntx100\":-64109,\"Category\":\"Loyer\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false},{\"ID\":6,\"GofiID\":2,\"Date\":\"2011-05-31\",\"Account\":\"A\",\"Product\":\"Salaire\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"1183.16\",\"PriceIntx100\":118316,\"Category\":\"Banque\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":10,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2013-06-02\",\"Exported\":false},{\"ID\":9,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2013-06-02\",\"Exported\":false},{\"ID\":8,\"GofiID\":2,\"Date\":\"2012-01-31\",\"Account\":\"CB\",\"Product\":\"ToDelete\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.53\",\"PriceIntx100\":-3453,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":6,\"GofiID\":2,\"Date\":\"2011-05-31\",\"Account\":\"A\",\"Product\":\"Salaire\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"1183.16\",\"PriceIntx100\":118316,\"Category\":\"Banque\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":false,\"DateChecked\":\"9999-12-31\",\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
