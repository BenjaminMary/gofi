...
func TestUser(t *testing.T) {
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi1-UTF8-LF.csv"))
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":1,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2024-01-14\",\"Mode\":0,\"Exported\":false},{\"ID\":2,\"GofiID\":2,\"Date\":\"2015-01-01\",\"Account\":\"Especes\",\"Product\":\"Solde Espèces\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"83.66\",\"PriceIntx100\":8366,\"Category\":\"Revenu\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2000-01-01\",\"Mode\":0,\"Exported\":false},{\"ID\":3,\"GofiID\":2,\"Date\":\"2015-01-02\",\"Account\":\"CA\",\"Product\":\"PC Portable\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-295.11\",\"PriceIntx100\":-29511,\"Category\":\"HighTech\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-05\",\"Mode\":0,\"Exported\":false},{\"ID\":4,\"GofiID\":2,\"Date\":\"2015-01-04\",\"Account\":\"CA\",\"Product\":\"Gazole\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-38.66\",\"PriceIntx100\":-3866,\"Category\":\"Vehicule\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-05\",\"Mode\":0,\"Exported\":false},{\"ID\":5,\"GofiID\":2,\"Date\":\"2015-01-05\",\"Account\":\"CA\",\"Product\":\"Jeux Steam\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-1.89\",\"PriceIntx100\":-189,\"Category\":\"Loisirs\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-06\",\"Mode\":0,\"Exported\":false},{\"ID\":6,\"GofiID\":2,\"Date\":\"2015-01-06\",\"Account\":\"CA\",\"Product\":\"Série S1 à S5\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.99\",\"PriceIntx100\":-3499,\"Category\":\"Cadeaux\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-07\",\"Mode\":0,\"Exported\":false},{\"ID\":7,\"GofiID\":2,\"Date\":\"2015-01-06\",\"Account\":\"Especes\",\"Product\":\"Cafés\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-1.60\",\"PriceIntx100\":-160,\"Category\":\"Courses\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2000-01-01\",\"Mode\":0,\"Exported\":false},{\"ID\":8,\"GofiID\":2,\"Date\":\"2015-01-07\",\"Account\":\"CA\",\"Product\":\"VÊTEMENT HOMME SKI TOP\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-13.95\",\"PriceIntx100\":-1395,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2000-01-01\",\"Mode\":0,\"Exported\":false},{\"ID\":9,\"GofiID\":2,\"Date\":\"2015-01-08\",\"Account\":\"CA\",\"Product\":\"Prêt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-150.00\",\"PriceIntx100\":-15000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-09\",\"Mode\":2,\"Exported\":false},{\"ID\":10,\"GofiID\":2,\"Date\":\"2015-01-09\",\"Account\":\"CA\",\"Product\":\"Remboursement Prêt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"150.00\",\"PriceIntx100\":15000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-10\",\"Mode\":4,\"Exported\":false},{\"ID\":11,\"GofiID\":2,\"Date\":\"2015-01-10\",\"Account\":\"CA\",\"Product\":\"Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"300.00\",\"PriceIntx100\":30000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-11\",\"Mode\":1,\"Exported\":false},{\"ID\":12,\"GofiID\":2,\"Date\":\"2015-01-11\",\"Account\":\"CA\",\"Product\":\"Remboursement Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-100.00\",\"PriceIntx100\":-10000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-12\",\"Mode\":3,\"Exported\":false},{\"ID\":13,\"GofiID\":2,\"Date\":\"2015-01-12\",\"Account\":\"CA\",\"Product\":\"Remboursement Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-200.00\",\"PriceIntx100\":-20000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-13\",\"Mode\":3,\"Exported\":false}]}\n",
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi2-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	require.Equal(t, http.StatusOK, response.Code, "should be equal")
	require.Equal(t,
		"{\"isValidResponse\":true,\"httpStatus\":200,\"info\":\"record list retrieved\",\"jsonContent\":[{\"ID\":1,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"1999-12-31\",\"Mode\":0,\"Exported\":false},{\"ID\":2,\"GofiID\":2,\"Date\":\"2015-01-01\",\"Account\":\"Especes\",\"Product\":\"Solde Espèces\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"85.76\",\"PriceIntx100\":8576,\"Category\":\"Revenu\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2023-01-01\",\"Mode\":0,\"Exported\":false},{\"ID\":3,\"GofiID\":2,\"Date\":\"2015-01-02\",\"Account\":\"CA\",\"Product\":\"PC Portable\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-295.11\",\"PriceIntx100\":-29511,\"Category\":\"HighTech\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-05\",\"Mode\":0,\"Exported\":false},{\"ID\":4,\"GofiID\":2,\"Date\":\"2015-01-04\",\"Account\":\"CA\",\"Product\":\"Gazole\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-38.66\",\"PriceIntx100\":-3866,\"Category\":\"Vehicule\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-05\",\"Mode\":0,\"Exported\":false},{\"ID\":5,\"GofiID\":2,\"Date\":\"2015-01-05\",\"Account\":\"CA\",\"Product\":\"Jeux Steam Remboursement Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-2.00\",\"PriceIntx100\":-200,\"Category\":\"Loisirs\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-06\",\"Mode\":3,\"Exported\":false},{\"ID\":6,\"GofiID\":2,\"Date\":\"2015-01-06\",\"Account\":\"CA\",\"Product\":\"Série S1 à S5 Prêt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-34.99\",\"PriceIntx100\":-3499,\"Category\":\"Cadeaux\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-07\",\"Mode\":2,\"Exported\":false},{\"ID\":7,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"1999-12-31\",\"Mode\":0,\"Exported\":false},{\"ID\":8,\"GofiID\":2,\"Date\":\"2015-01-07\",\"Account\":\"CA\",\"Product\":\"VÊTEMENT HOMME SKI TOP\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-13.95\",\"PriceIntx100\":-1395,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2024-01-01\",\"Mode\":0,\"Exported\":false},{\"ID\":9,\"GofiID\":2,\"Date\":\"2015-01-08\",\"Account\":\"CA\",\"Product\":\"Prêt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-150.00\",\"PriceIntx100\":-15000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-09\",\"Mode\":2,\"Exported\":false},{\"ID\":10,\"GofiID\":2,\"Date\":\"2015-01-09\",\"Account\":\"CA\",\"Product\":\"Remboursement Prêt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"150.00\",\"PriceIntx100\":15000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-10\",\"Mode\":0,\"Exported\":false},{\"ID\":11,\"GofiID\":2,\"Date\":\"2015-01-10\",\"Account\":\"CA\",\"Product\":\"Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"300.00\",\"PriceIntx100\":30000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-11\",\"Mode\":1,\"Exported\":false},{\"ID\":12,\"GofiID\":2,\"Date\":\"2015-01-11\",\"Account\":\"CA\",\"Product\":\"Remboursement Emprunt\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"-100.00\",\"PriceIntx100\":-10000,\"Category\":\"Voyage\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"2015-01-12\",\"Mode\":3,\"Exported\":false},{\"ID\":13,\"GofiID\":2,\"Date\":\"1999-12-31\",\"Account\":\"-\",\"Product\":\"DELETED LINE\",\"PriceDirection\":\"\",\"FormPriceStr2Decimals\":\"0.00\",\"PriceIntx100\":0,\"Category\":\"-\",\"CommentInt\":0,\"CommentString\":\"\",\"Checked\":true,\"DateChecked\":\"1999-12-31\",\"Mode\":0,\"Exported\":false}]}\n",
		response.Body.String(), "should be equal")
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi3-UTF8-CRLF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi4-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi5-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi6-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi7-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
	...
	file, _ = os.Open(filepath.Join(os.Getenv("EXE_PATH"), "back", "api", "test", "csv", "gofi8-UTF8-LF.csv"))
	require.NoError(t, err)
	io.Copy(part, file)
	writer.Close()
	req, _ = http.NewRequest("POST", "/api/csv/import", body)
